...
#!/bin/bash
# author：MrDanielWT
# website：https://github.com/MrDanielWT
...
EOF
  ...
  # Gitee Pages
  #git push --force --quiet "https://MrDanielWT:${GH_TOKEN}@${GITEE_REF}" master:master
  ...
  # Gitee Pages
  #git push --quiet "https://MrDanielWT:${GH_TOKEN}@${GITEE_REF}" master:master --tags
}
